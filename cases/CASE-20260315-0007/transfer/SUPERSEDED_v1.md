...
- **Pair:** CASE-0007 ↔ CASE-0001
- **Superseding v2 run:** cases/CASE-20260311-0001/transfer_v2/CASE-0001_vs_CASE-0007/ — Φ = 0.625, partially_admissible
- **v1 values recorded here (for provenance only):** Φ = 0.5317 (inadmissible), PCI = 0.5, RCD = 2, SDI = 4
