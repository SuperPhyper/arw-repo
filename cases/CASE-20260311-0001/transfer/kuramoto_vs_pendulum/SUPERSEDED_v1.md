...
- **Pair:** CASE-0001 ↔ CASE-0002
- **Superseding v2 run:** cases/CASE-20260311-0001/transfer_v2/DCTRL2_0001_vs_0002/ (same pair, run as decoupling control DCTRL2)
- **v1 values recorded here (for provenance only):** Φ = 0.675 (partially_admissible), PCI = 0.75, RCD = 1, SDI = 2
