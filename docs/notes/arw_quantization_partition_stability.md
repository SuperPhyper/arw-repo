...
| Q-QPS-7 | The three latency mechanisms (Δ-averaging, ε-blindness, B-inadmissibility) are presented as distinct. Are they formally independent, or does each reduce to the others under specific conditions? A precise classification of latency mechanisms would sharpen the descriptive collapse framework and clarify which mechanism is operative in each physical and typological case. | Formal | medium |
