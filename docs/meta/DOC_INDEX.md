...
| docs/art_instantiations/kht_resonance_dialectic.md | hypothesis | KHT Resonance Dialectic, unification of three resonance senses (formal/admissibility/procedural), duality (V₄) as thesis–antithesis form, R3 mediation vs R4 collapse, maximin joint-admissibility criterion m*=argmax min(R(m,x_A),R(m,x_B)) | — | Synthesis node integrating glossary/resonance + resonance_dialectic_context_navigation + kht_architecture_layer3 §5.4; depends on kht_architecture_layer1/3, kht_state_notation, kht_group_dynamics; Q-RD-1–4; added 2026-06-29 |
...
| docs/notes/scope_component_conflict_typology.md | note | scope-tuple conflict typology (ε/Δ/Π/B-conflict classification of controversies), Π-monopolization as fifth orthogonal conflict mode | — | Imported 2026-07-11 from To-REPO (Kaffeehaus session 2026-07-04); used the more complete of two offline-reconstructed variants (base duplicate discarded, see maintenance note in file); registers Q_NEW_A–D |
